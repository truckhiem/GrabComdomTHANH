...
public class NewArrivalAdapter extends BaseAdapter{
    ...
    public NewArrivalAdapter(Activity activity, ArrayList<String> listCountry, ArrayList<Integer> listFlag) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            view = new ViewHolder();
            convertView = inflator.inflate(R.layout.new_arrival_row, null);
